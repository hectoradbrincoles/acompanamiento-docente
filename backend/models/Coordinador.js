...
CoordinadorSchema.pre('save', async function (next) {
...
CoordinadorSchema.methods.compararContrasena = function (entrada) {
  return bcrypt.compare(entrada, this.contrasena);
};

CoordinadorSchema.methods.toJSON = function () {
